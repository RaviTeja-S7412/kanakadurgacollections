   ...
   /* Manage Frontend Captcha Settings Credentials */
    ...
    function catalog_admin($para1 = "")
    {
        ...
        if ($para1 == 'update_password') {
            ...
            $page_data['page_name'] = "catalog_admin";
            $page_data['catalog'] = $this->db->get('catalog')->result_array();
            $this->load->view('back/index', $page_data);
        }
    }
    ...
    function uploadCatalog(){
        ...
        $data=array("Date"=>date("Y-m-d H:i:s A"),"Title"=>$title,"FileName"=>$fname);
    ...
    function default_images($para1 = "",$para2 = "")
    {
        ...
        $page_data['default_list'] = array('product_image','digital_logo_image','category_image','sub_category_image','brand_image','blog_image','banner_image','user_image');
