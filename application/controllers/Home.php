...
class Home extends CI_Controller
{
   ...
   function vendor_logup($para1 = "", $para2 = "")
    ...
    function catalog(){
        ...
        $page_data['asset_page']    = "home";
        $page_data['page_title']    = translate('home');
        $page_data['catalog']    = $this->db->order_by("Sno","desc")->get("catalog")->result_array();
        $this->benchmark->mark('code_start');
        $this->load->view('front/catalog', $page_data);
    ...
    function cart_finish($para1 = "", $para2 = "")
    {
        ...
        if($this->input->post('payment_type') == "icicibank"){
            ...
            redirect(("home/icicipay/".$sale_id));
    ...
    function icicipay($sale_id){
        $data["odata"] = $this->db->get_where("sale",["sale_id"=>$sale_id])->row();
        $this->load->vieW("front/icicipayment-gateway/saleApi", $data);
    }

    function icicipayProcesssale(){
        $this->load->vieW("front/icicipayment-gateway/processSale");
    }

    function icici_pay_response()
    {

        $this->load->view("front/icicipayment-gateway/responseSale");
