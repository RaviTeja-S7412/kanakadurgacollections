               ...
               <div class="container">
                <div class="panel">
                    <div class="panel-body">
                        <?
if(count($catalog)>0){
    echo "<br/><h4>Brand Catalog >></h4><br/>";
    echo '<div class="row">';
    foreach($catalog as $item){ ?>
    <div class="col-md-4">
        <center><img src="<? echo base_url(); ?>uploads/others/pdficon.png" width="90">
        <p style="font-size:20px;text-align:center"><? echo $item['Title']; ?></p>
        <a href="<? echo base_url(); ?>uploads/catalog/<? echo  $item['FileName']; ?>" target="_blank" class="btn btn-primary">Download</a>
        </center>
    </div>
    <? }
    echo "</div>";
}else{
    echo "<h4><center>We will upload Brand Catagory Soon.<center></h4>";
}
                        ?>
                    </div>
                </div>
