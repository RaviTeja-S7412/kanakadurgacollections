...
define('MERCHANTID', '100000000005837'); //This is not being used in kit but for your reference in case of use it as global
define('TERMINALID', 'EG000481'); //This is not being used in kit but for your reference in case of use it as global
define('BANKID', '24520'); //Must be 6 digit only. No special characters allowed
define('MCC', '8661'); //Must be 4 digit only. No special characters allowed
