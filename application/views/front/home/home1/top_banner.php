            ...
            <div class="row">
                ...
                <div class="col-md-<?php echo $md; ?> col-sm-<?php echo $sm; ?> col-xs-<?php echo $xs; ?>">
                    <div class="thumbnail no-border no-padding thumbnail-banner size-1x<?php echo $count; ?>">
                        ...
                        <img class="image_delay" data-src="<?php echo $this->crud_model->file_view('banner',$row['banner_id'],'','','no','src','','',$row['image_ext']) ?>"  style="background-image: url('<?php echo img_loading(); ?>')" alt=""/> 
                                </a>
                        </div>
                    </div>
                </div>
