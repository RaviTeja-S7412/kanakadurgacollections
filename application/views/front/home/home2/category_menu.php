...
<section class="page-section category_menu">
    <div class="container">
        <div class="row main-slider-row">
                                            ...
                                            <div class="vertical-wrapper">
                                                ...
                                                <div class="megamenu-pattern">
                                                    <ul class="megamenu">
														...
														?>
                                                        <li
                                                            class="item-vertical style1 with-sub-menu hover category_side_set">
            ...
            <div class="col-md-2 col-xs-12 padding-r-0-md hidden-sm hidden-xs"
                style="background: #fff; box-shadow: 2px 1px 6px #dcdcdc;">
                    ...
                    <div class="thumbnail">
                        <div class="media">
                            <span class="media-link" style="height: auto;">
                                <img class="img-responsive image_delay" src="<?php echo img_loading(); ?>"
                                    data-src="<?php echo $this->crud_model->file_view('product',$row['product_id'],'','','thumb','src','multi','one');?>"
                                    alt="">
                                <span class="icon-view"
                                    onclick="quick_view('<?php echo $this->crud_model->product_link($row['product_id'],'quick'); ?>')"
