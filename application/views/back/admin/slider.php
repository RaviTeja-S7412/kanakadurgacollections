		...
		<div class="panel">
			<div class="panel-body">
                <div class="tab-content">
                    <div class="col-md-12">
                        <button class="btn btn-primary btn-lg btn-labeled fa fa-plus-circle add_pro_btn pull-right" 
                        ...
                        <button class="btn btn-info btn-lg btn-labeled fa fa-plus-circle add_pro_btn pull-right" 
                        	onclick="ajax_set_list()">
								<?php echo translate('slider_list');?>
                        </button>
                        <button class="btn btn-purple btn-lg btn-labeled fa fa-align-justify add_pro_btn pull-right" 
