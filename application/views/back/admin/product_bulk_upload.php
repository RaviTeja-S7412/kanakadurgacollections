                                        ...
                                        <div class="details-wrap">
                                            <div class="panel">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div>
<a class="btn btn-lg btn-primary btn-dark" target="_blank" download
                                                        ...
                                                        <a class="btn btn-lg btn-primary" target="_blank" download
                                            ...
                                            <div class="panel">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div>
                                                        ...
                                                        <button data-target="#product_category" type="button" class="btn btn-lg btn-primary"
                                                                data-toggle="modal"><?php echo translate("Category ID List") ?></button>
                                                        <button data-target="#product_sub_category" type="button" class="btn btn-lg btn-primary"
                                                                data-toggle="modal"><?php echo translate("Sub Category ID List") ?></button>
                                                        <button data-target="#product_brand" type="button" class="btn btn-lg btn-primary"
                                            ...
                                            <div class="panel mb-0">
                                                ...
                                                <div class="panel-body">
                                                    <?php
                                                    echo form_open(base_url() . 'admin/product_bulk_upload_save', array(
                                                        'class' => 'form',
                                                        'method' => 'post',
                                                        'id' => '',
                                                ...
                                                <span class="btn btn-lg btn-default btn-file">
                                                    ...
                                                    <div class="form-group">
                                                        <button class="btn btn-lg btn-mint btn-labeled fa fa-upload" type="submit"><?php echo translate("Upload Products") ?></button>
                                                    </div>
                                                    <?php echo form_close() ?>
