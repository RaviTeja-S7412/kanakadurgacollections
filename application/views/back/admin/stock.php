	...
	<div class="tab-base">
		<div class="panel">
			<div class="panel-body">
                ...
                <div class="col-md-12">
                	<button class="btn btn-dark btn-lg btn-labeled fa fa-minus-square pull-right" 
					...
					<button class="btn btn-primary btn-lg btn-labeled fa fa-plus-circle pull-right mar-rgt" 
