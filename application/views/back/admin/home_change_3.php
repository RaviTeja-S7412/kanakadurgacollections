    ...
    <div class="col-md-12">
        ...
        <div class="tab-base horizontal-tab">
            <ul class="nav nav-tabs">
                <li class="active">
                    <a data-toggle="tab" href="#tabb-1"
                        style="padding:5px 8px !important"><?php echo translate('top_slider'); ?></a>
                </li>
                <li>
                    <a data-toggle="tab" href="#tabb-2"
                        style="padding:5px 8px !important"><?php echo translate('home_banners'); ?></a>
                </li>
                <li>
                    <a data-toggle="tab" href="#tabb-3"
                        style="padding:5px 8px !important"><?php echo translate('todays_deal'); ?></a>
                </li>
                <li>
                    <a data-toggle="tab" href="#tabb-4"
                        style="padding:5px 8px !important"><?php echo translate('featured_products'); ?></a>
                </li>
                <li>
                    <a data-toggle="tab" href="#tabb-10"
                        style="padding:5px 8px !important"><?php echo translate('product_bundle'); ?></a>
                </li>
                <li>
                    <a data-toggle="tab" href="#tabb-11"
                        style="padding:5px 8px !important"><?php echo translate('customer_products'); ?></a>
                </li>
                <?php
                if($this->crud_model->get_type_name_by_id('general_settings','58','value') == 'ok'){
                    ?>
                <li>
                    <a data-toggle="tab" href="#tabb-5"
                        style="padding:5px 8px !important"><?php echo translate('vendors'); ?></a>
                </li>
                <?php
                }
                ?>
                <li>
                    <a data-toggle="tab" href="#tabb-6"
                        style="padding:5px 8px !important"><?php echo translate('category_wise_products'); ?></a>
                </li>
                <li>
                    <a data-toggle="tab" href="#tabb-7"
                        style="padding:5px 8px !important"><?php echo translate('blogs'); ?></a>
                </li>
                <li>
                    <a data-toggle="tab" href="#tabb-8"
                        style="padding:5px 8px !important"><?php echo translate('special_products'); ?></a>
                </li>
                <?php
                if($this->crud_model->get_type_name_by_id('general_settings','68','value') == 'ok'){
                    ?>
                <li>
                    <a data-toggle="tab" href="#tabb-9"
                        style="padding:5px 8px !important"><?php echo translate('brands'); ?></a>
                </li>
                <?php
                }
                ?>
                    ...
                    <div class="row">
                        <div class="col-md-12 form-horizontal">
                            <div class="form-group">
                                <label
                                    class="col-sm-3 control-label"><?php echo translate('top_carousel_slider');?></label>
                                <div class="col-sm-6">
                                    <input id="set_slides" class='sw' data-set='set_slides' type="checkbox"
                                        <?php if($this->crud_model->get_type_name_by_id('general_settings','62','value') == 'ok'){ ?>checked<?php } ?> />
                                </div>
                            </div>
                            <?php
                            ...
                            <div class="form-group top_cat">
                                <label class="col-sm-3 control-label"
                                    for="demo-hor-3"><?php echo translate('choose_categories_(max_10)');?></label>
                                <div class="col-sm-6">
                                    <?php
                            ...
                            <div class="form-group col-sm-12 top_cat_update" style="margin-bottom:300px">
                                <span class="btn btn-success btn-labeled fa fa-check submitter pull-right enterer"
                                    type=data-ing='<?php echo translate('updating'); ?>'
                                    data-msg='<?php echo translate('category_menu_updated!'); ?>'>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <img class="img-responsive img_show img-banner"
                                                    src="<?php echo $this->crud_model->file_view('banner',$row['banner_id'],'','','thumb','src','','',$row['image_ext']) ?>"
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <input id="ban_<?php echo $row['banner_id']; ?>"
                                                    ...
                                                    <?php if($row['status'] == 'ok'){ ?>checked<?php } ?> value="ok" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                ...
                <div id="tabb-3" class="tab-pane fade">
                    <div class="row">
                        <div class="col-md-12 form-horizontal">
                            ...
                            <div class="form-group">
                                <label
                                    class="col-sm-3 control-label"><?php echo translate('todays_deal_(_show_/_hide_)');?></label>
                                <div class="col-sm-6">
                                    <input id="feature_59" data-id="59" class='sw2' type="checkbox" name="value" <?php if($this->crud_model->get_type_name_by_id('ui_settings','59','value') == 'ok'){
                                           ?>checked<?php } ?> value="ok" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label
                                    class="col-sm-3 control-label"><?php echo translate('number_of_products_(_to_show_)');?></label>
                                <div class="col-sm-6">
                                    <input type="number" name="flash_no"
                                        value="<?php echo $this->crud_model->get_type_name_by_id('ui_settings','61','value'); ?>"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"
                                    style="margin-top:15px;"><?php echo translate('choose_product_box_style');?></label>
                                <div class="col-sm-6">
                                    <div class="row">
                                        <?php
                                        ...
                                        <div class="cc-selector col-sm-4">
                                            <input type="radio" id="deal_box_<?php echo $value; ?>"
                                                value="<?php echo $value; ?>" name="deal_pro_box"
                                                <?php if($box_style == $value){ echo 'checked'; } ?>>
                                            <label class="drinkcard-cc" style="margin-bottom:0px; width:100%;"
                                                for="deal_box_<?php echo $value; ?>">
                                                <img src="<?php echo base_url() ?>uploads/product_boxes/<?php echo 'product_grid_'.$value.'.jpg' ?>"
                            ...
                            <div class="form-group col-sm-12">
                                <span class="btn btn-success btn-labeled fa fa-check submitter pull-right enterer"
                                    type=data-ing='<?php echo translate('updating'); ?>'
                                    data-msg='<?php echo translate('flash_section_updated!'); ?>'>
                                    <?php echo translate('update');?>
                                </span>
                            </div>
                            </form>
                ...
                <div id="tabb-4" class="tab-pane fade">
                    <div class="row">
                        <div class="col-md-12 form-horizontal">
                            ...
                            <div class="form-group">
                                <label
                                    class="col-sm-3 control-label"><?php echo translate('featured_products_(_show_/_hide_)');?></label>
                                <div class="col-sm-6">
                                    <input id="feature_24" data-id="24" class='sw2' type="checkbox" name="value" <?php if($this->crud_model->get_type_name_by_id('ui_settings','24','value') == 'ok'){
                                           ?>checked<?php } ?> value="ok" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label
                                    class="col-sm-3 control-label"><?php echo translate('number_of_products_(_to_show_)');?></label>
                                <div class="col-sm-6">
                                    <input type="number" name="featured_no"
                                        value="<?php echo $this->crud_model->get_type_name_by_id('ui_settings','20','value'); ?>"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="row">
                                        ...
                                        foreach($style as $value){
                                            ?>
                                        <div class="cc-selector col-sm-4">
                                            <input type="radio" id="fea_box_<?php echo $value; ?>"
                                                value="<?php echo $value; ?>" name="fea_pro_box"
                                                <?php if($box_style == $value){ echo 'checked'; } ?>>
                                            <label class="drinkcard-cc" style="margin-bottom:0px; width:100%;"
                                                for="fea_box_<?php echo $value; ?>">
                                                <img src="<?php echo base_url() ?>uploads/product_boxes/<?php echo 'product_grid_'.$value.'.jpg' ?>"
                                                    width="100%" height="100%"
                                                    alt="<?php echo 'product_box_style_'.$value; ?>" />
                            ...
                            <div class="form-group col-sm-12">
                                <span class="btn btn-success btn-labeled fa fa-check submitter pull-right enterer"
                                    type=data-ing='<?php echo translate('updating'); ?>'
                                    data-msg='<?php echo translate('featured_section_updated!'); ?>'>
                                    <?php echo translate('update');?>
                                </span>
                            </div>
                            </form>
                ...
                <div id="tabb-5" class="tab-pane fade">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label
                                    class="col-sm-3 control-label"><?php echo translate('vandor_(_show_/_hide_)');?></label>
                                <div class="col-sm-6">
                                    <input id="feature_25" data-id="25" class='sw2' type="checkbox" name="value" <?php if($this->crud_model->get_type_name_by_id('ui_settings','25','value') == 'ok'){
                                               ?>checked<?php } ?> value="ok" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label
                                    class="col-sm-3 control-label"><?php echo translate('parallax_title_for_vendors');?></label>
                                <div class="col-sm-6">
                                    <input type="text" name="pv_title"
                                        value="<?php echo $this->crud_model->get_type_name_by_id('ui_settings','17','value'); ?>"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="form-group margin-top-10">
                                <label class="col-sm-3 control-label margin-top-10"
                                    for="demo-hor-inputemail"><?php echo translate('parallax_image_for_vendors');?></label>
                                <div class="col-sm-9">
                                    <div class="col-sm-5" style="margin:2px;padding:2px;">
                                        <img class="img-responsive img-md img-border img_show2"
                                            style="width:100%;height:150px"
                                            src="<?php echo base_url(); ?>uploads/others/parralax_vendor.jpg"
                                            id="blah3">
                                    </div>
                                    <br />
                                    <br />
                            ...
                            <div class="form-group">
                                <label
                                    class="col-sm-3 control-label"><?php echo translate('number_of_vendor_(_to_show_)');?></label>
                                <div class="col-sm-6">
                                    <input type="number" name="vendor_no"
                                        value="<?php echo $this->crud_model->get_type_name_by_id('ui_settings','21','value'); ?>"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="form-group col-sm-12">
                                <span class="btn btn-success btn-labeled fa fa-check submitter pull-right enterer"
                                    type=data-ing='<?php echo translate('updating'); ?>'
                                    data-msg='<?php echo translate('vendor_section_updated!'); ?>'>
                                    <?php echo translate('update');?>
                                </span>
                            </div>
                            </form>
                ...
                <div id="tabb-6" class="tab-pane fade">
                    <div class="row">
                        <div class="col-md-12 form-horizontal">
                            ...
                            <div id="home_category_selection_box">
                                ...
                                <div class="col-sm-12 element_box">
                                            ...
                                            <?php
                                                    ...
                                                    foreach($category as $cat){
                                                        ...
                                                        if($this->crud_model->if_publishable_category($cat['category_id'])){
                                                            ?>
                                            <div class="col-sm-3 radio_checker category_btn cat_<?php echo $cat['category_id']; ?>"
                                                onClick="get_cat('<?php echo $cat['category_id']; ?>',this)">
                                                <span class="cat_text">
                                                    <?php echo $cat['category_name']; ?>
                                                </span>
                                                <input type="checkbox" style="display:none;" class="radio_pat"
                                                    <?php if($cdata['category'] == $cat['category_id']){ ?>checked<?php } ?>
                                    ...
                                    <div class="form-group sub">
                                        <label class="col-sm-3 control-label"
                                            for="demo-hor-3"><?php echo translate('sub-categories_(max 4)');?></label>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="btn btn-mint btn-labeled fa fa-plus-square pull-right add_new"
                                        onClick="add_home_cat_box()">
                                ...
                                <div class="col-sm-6">
                                    <div class="row">
                                        ...
                                        foreach($style as $value){
                                            ?>
                                        <div class="cc-selector col-sm-4">
                                            <input type="radio" id="pbox_<?php echo $value; ?>"
                                                value="<?php echo $value; ?>" name="box_style"
                                                <?php if($box_style == $value){ echo 'checked'; } ?>>
                                            <label class="drinkcard-cc" style="margin-bottom:0px; width:100%;"
                                                for="pbox_<?php echo $value; ?>">
                                                <img src="<?php echo base_url() ?>uploads/product_boxes/<?php echo 'product_grid_'.$value.'.jpg' ?>"
                                                    width="100%" height="100%"
                                                    alt="<?php echo 'product_box_style_'.$value; ?>" />
                            ...
                            <div class="form-group col-sm-12">
                                <span class="btn btn-success btn-labeled fa fa-check submitter pull-right enterer"
                                    type=data-ing='<?php echo translate('updating'); ?>'
                                    data-msg='<?php echo translate('home_categories_updated!'); ?>'>
                                    <?php echo translate('update');?>
                                </span>
                            </div>
                            </form>
                ...
                <div id="tabb-7" class="tab-pane fade">
                    <div class="row">
                        <div class="col-md-12 form-horizontal">
                            ...
                            <div class="form-group">
                                <label
                                    class="col-sm-3 control-label"><?php echo translate('blog_(_show_/_hide_)');?></label>
                                <div class="col-sm-6">
                                    <input id="feature_26" data-id="26" class='sw2' type="checkbox" name="value" <?php if($this->crud_model->get_type_name_by_id('ui_settings','26','value') == 'ok'){
                                           ?>checked<?php } ?> value="ok" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label
                                    class="col-sm-3 control-label"><?php echo translate('parallax_title_for_blog');?></label>
                                <div class="col-sm-6">
                                    <input type="text" name="pb_title"
                                        value="<?php echo $this->crud_model->get_type_name_by_id('ui_settings','19','value'); ?>"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="form-group margin-top-10">
                                <label class="col-sm-3 control-label margin-top-10"
                                    for="demo-hor-inputemail"><?php echo translate('parallax_image_for_blog');?></label>
                                <div class="col-sm-9">
                                    <div class="col-sm-5" style="margin:2px;padding:2px;">
                                        <img class="img-responsive img-md img-border img_show2"
                                            style="width:100%;height:150px"
                            ...
                            <div class="form-group col-sm-12">
                                <span class="btn btn-success btn-labeled fa fa-check submitter pull-right enterer"
                                    type=data-ing='<?php echo translate('updating'); ?>'
                                    data-msg='<?php echo translate('blog_section_updated!'); ?>'>
                                    <?php echo translate('update');?>
                                </span>
                            </div>
                            </form>
                ...
                <div id="tabb-8" class="tab-pane fade">
                    <div class="row">
                        <div class="col-md-12 form-horizontal">
                            <div class="form-group">
                                <label
                                    class="col-sm-3 control-label"><?php echo translate('special_products_(_show_/_hide_)');?></label>
                                <div class="col-sm-6">
                                    <input id="feature_31" data-id="31" class='sw2' type="checkbox" name="value" <?php if($this->crud_model->get_type_name_by_id('ui_settings','31','value') == 'ok'){
                                           ?>checked<?php } ?> value="ok" />
                                </div>
                            </div>
                        </div>
                ...
                <div id="tabb-9" class="tab-pane fade">
                    <div class="row">
                        <div class="col-md-12 form-horizontal">
                            ...
                            <div class="form-group">
                                <label
                                    class="col-sm-3 control-label"><?php echo translate('brand_(_show_/_hide_)');?></label>
                                <div class="col-sm-6">
                                    <input id="feature_23" data-id="23" class='sw2' type="checkbox" name="value" <?php if($this->crud_model->get_type_name_by_id('ui_settings','23','value') == 'ok'){
                                               ?>checked<?php } ?> value="ok" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label
                                    class="col-sm-3 control-label"><?php echo translate('number_of_brand_(_to_show_)');?></label>
                                <div class="col-sm-6">
                                    <input type="number" name="brand_no"
                                        value="<?php echo $this->crud_model->get_type_name_by_id('ui_settings','22','value'); ?>"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="form-group col-sm-12">
                                <span class="btn btn-success btn-labeled fa fa-check submitter pull-right enterer"
                                    type=data-ing='<?php echo translate('updating'); ?>'
                                    data-msg='<?php echo translate('brand_section_updated!'); ?>'>
                                    <?php echo translate('update');?>
                                </span>
                            </div>
                            </form>
                ...
                <div id="tabb-10" class="tab-pane fade">
                    <div class="row">
                        <div class="col-md-12 form-horizontal">
                            ...
                            <div class="form-group">
                                <label
                                    class="col-sm-3 control-label"><?php echo translate('product_bundle_(_show_/_hide_)');?></label>
                                <div class="col-sm-6">
                                    <input id="product_bundle_40" data-id="40" class='sw3' type="checkbox" name="value" <?php if($this->crud_model->get_type_name_by_id('ui_settings','40','value') == 'ok'){
                                           ?>checked<?php } ?> value="ok" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" name="bundle_no"
                                        value="<?php echo $this->crud_model->get_type_name_by_id('ui_settings','41','value'); ?>"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="row">
                                        ...
                                        foreach($style as $value){
                                            ?>
                                        <div class="cc-selector col-sm-4">
                                            <input type="radio" id="pb_box_<?php echo $value; ?>"
                                                value="<?php echo $value; ?>" name="fea_pro_box"
                                                <?php if($box_style == $value){ echo 'checked'; } ?>>
                                            <label class="drinkcard-cc" style="margin-bottom:0px; width:100%;"
                            ...
                            <div class="form-group col-sm-12">
                                <span class="btn btn-success btn-labeled fa fa-check submitter pull-right enterer"
                                    type=data-ing='<?php echo translate('updating'); ?>'
                                    data-msg='<?php echo translate('bundle_product_section_updated!'); ?>'>
                                    <?php echo translate('update');?>
                                </span>
                            </div>
                            </form>
                ...
                <div id="tabb-11" class="tab-pane fade">
                    <div class="row">
                        <div class="col-md-12 form-horizontal">
                            ...
                            <div class="form-group">
                                <label
                                    class="col-sm-3 control-label"><?php echo translate('customer_product_(_show_/_hide_)');?></label>
                                <div class="col-sm-6">
                                    <input id="customer_product_43" data-id="43" class='sw8' type="checkbox"
                                        name="value" <?php if($this->crud_model->get_type_name_by_id('ui_settings','43','value') == 'ok'){
                                           ?>checked<?php } ?> value="ok" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label
                                    class="col-sm-3 control-label"><?php echo translate('number_of_product_(_to_show_)');?></label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group col-sm-12">
                                <span class="btn btn-success btn-labeled fa fa-check submitter pull-right enterer"
                                    type=data-ing='<?php echo translate('updating'); ?>'
                                    data-msg='<?php echo translate('customer_product_section_updated!'); ?>'>
                                    <?php echo translate('update');?>
                                </span>
                            </div>
                            </form>
...
function add_home_cat_box() {
    $('#home_category_selection_box').append('' +
        ...
        '          <?php
                ...
                if($this->crud_model->if_publishable_category($cat['category_id'])){
                ?>' +
        '              <div class="col-sm-4 radio_checker category_btn cat_<?php echo $cat['category_id']; ?>" onClick="get_cat(' +
        "'" + <?php echo $cat['category_id']; ?> + "'" + ',this)">' +
        "                  <?php echo $cat['category_name']; ?>" +
        '                  <input type="checkbox" style="display:none;" class="radio_pat"' +
        '                      value="<?php echo $cat['category_id']; ?>" name="category[]" />' +
        '              </div>' +
...
function disable_selected_cat() {
    ...
    setTimeout(function() {
        var p = $('#home_category_selection_box').find('.category_select_div').eq(0).find('.category_btn')
            .length;
...
function get_cat(id, now) {
    ...
    parent.find('.sub_cat').load(base_url + 'admin/ui_settings/sub_by_cat/' + id,
        function() {
            ...
            parent.find('.demo-cs-multiselect').chosen({
                width: '100%'
            });
        }
    );
...
$(document).ready(function() {
    ...
    $(".sw").each(function() {
        ...
        var id = h.attr('id');
        var set = h.data('set');
        new Switchery(document.getElementById(id), {
        ...
        changeCheckbox.onchange = function() {
            //alert($(this).data('id'));
            ajax_load(base_url + '' + user_type + '/general_settings/' + set + '/' + changeCheckbox
                .checked, 'site', 'othersd');
    ...
    $(".sw1").each(function() {
        ...
        changeCheckbox.onchange = function() {
            ajax_load('<?php echo base_url(); ?>admin/banner/banner_publish_set/' + $(this).data(
                'id') + '/' + changeCheckbox.checked, 'prod', 'others');
            if (changeCheckbox.checked == true) {
                $.activeitNoty({
                    type: 'success',
                    icon: 'fa fa-check',
    ...
    $(".sw2").each(function() {
        ...
        changeCheckbox.onchange = function() {
            ajax_load('<?php echo base_url(); ?>admin/ui_settings/ui_home/feature_publish_set/' + $(
                this).data('id') + '/' + changeCheckbox.checked, '', '');
            if (changeCheckbox.checked == true) {
                $.activeitNoty({
                    type: 'success',
                    icon: 'fa fa-check',
    ...
    $(".sw3").each(function() {
        ...
        changeCheckbox.onchange = function() {
            ajax_load(
                '<?php echo base_url(); ?>admin/ui_settings/ui_home/product_bundle_publish_set/' +
                $(this).data('id') + '/' + changeCheckbox.checked, '', '');
            if (changeCheckbox.checked == true) {
                $.activeitNoty({
                    type: 'success',
