        ...
        <div class="form-group">
            ...
            <div class="col-sm-4 box_area">
                <div class="cc-selector">
                    <input type="radio" id="home_<?php echo $value; ?>" value="<?php echo $value; ?>" name="home_page"
                        <?php if($home_style == $value){ echo 'checked'; } ?>>
                    <label class="drinkcard-cc" style="margin-bottom:0px; width:100%;" for="home_<?php echo $value; ?>">
                        <div class="col-sm-12">
                            <div class="img_show">
                                <img src="<?php echo base_url() ?>uploads/home_pages/<?php echo 'home_'.$value.'.jpg' ?>"
                                    width="100%" style=" text-align-last:center;"
                                    alt="<?php echo 'home_style_'.$value; ?>" />
                            </div>
                        </div>
                    </label>
                </div>
...
<div class="panel-footer text-right">
    <span class="btn btn-info submitter enterer" data-ing='<?php echo translate('updating..'); ?>'
        data-msg='<?php echo translate('home_page_updated!'); ?>' onClick="check_style()">
...
function check_style() {
    ...
    $("#home_item_set").load("<?php echo base_url()?>admin/home_item_change/3");
}
</script>
<style>
.horizontal-tab {
